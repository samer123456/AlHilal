...
<section role="main" class="content-body">
	<header class="page-header">
		<h2>Add - Update - Delete Our Products</h2>
			...
			<div class="col-md-10">
				...
				<div class="panel-body">
					...
					<div id="modalForm" class="modal-block modal-block-primary mfp-hide">
						<form action="<?php echo base_url(); ?>adminpanel/product/addProduct/" id="demo-form"
						...
						<div id="turkish" class="tab-pane active">
							<div class="panel-body">
								<table class="table">
									...
									<?php
									$no = 0;
									foreach ($product_tr as $rs) {
										$no++;
										?>
										<form action="<?php echo base_url(); ?>adminpanel/product/updateProduct/<?php echo $rs->product_id; ?>"
											  method="POST">
											<tr>
												<th scope="row"><?php echo $no; ?></th>
												<td>
													<a href="<?php echo base_url(); ?>adminpanel/product/loadImage/<?php echo $rs->product_id; ?>"><img
																width="150px"
																src="<?php echo base_url(); ?>uploads/<?php echo $rs->image_name; ?>"></a>
												</td>
												<td><input type="text" name="title" class="form-control"
														   value="<?php echo $rs->image_title; ?>"></td>
												<td>
													<button type="submit" class="btn btn-primary"><i
																class="fa fa-edit"></i>
														Save
													</button>
													<a href="<?php echo base_url(); ?>adminpanel/product/deleteProduct/<?php echo $rs->product_id; ?>">
