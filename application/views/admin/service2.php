			...
			<div class="col-md-10">
				...
				<div class="panel-body">
					...
					<div id="modalForm" class="modal-block modal-block-primary mfp-hide">
						<form action="<?php echo base_url(); ?>adminpanel/service2/addService" id="demo-form" class="form-horizontal mb-lg" enctype="multipart/form-data" method="POST">
							<section class="panel">
								...
								<table class="table">
									...
									<tbody>
										...
										foreach ($service_tr as $rs) {
											$no++;
										?>
											<form action="<?php echo base_url(); ?>adminpanel/service2/updateService/<?php echo $rs->id; ?>" method="POST">
												<tr>
													<th scope="row"><?php echo $no; ?></th>
													<td>
														<a href="<?php echo base_url(); ?>adminpanel/service2/loadImage/<?php echo $rs->id; ?>"><img width="150px" src="<?php echo base_url(); ?>uploads/<?php echo $rs->image; ?>"></a>
													</td>
													...
													<td>
														...
														<a href="<?php echo base_url(); ?>adminpanel/service2/deleteService/<?php echo $rs->id; ?>">
