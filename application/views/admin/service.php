	...
	<div class="container">
		<div class="row">
			...
			<div class="panel-body">
				<a class="modal-with-form btn btn-primary" href="#modalForm">Add a new tab</a>
				<div id="modalForm" class="modal-block modal-block-primary mfp-hide">
					<form action="<?php echo base_url(); ?>adminpanel/service/addService/" id="demo-form" class="form-horizontal mb-lg" enctype="multipart/form-data" method="POST">
						<section class="panel">
							<header class="panel-heading">
								<h2 class="panel-title">Add a new tab</h2>
							</header>
							<div class="panel-body">
								<div class="form-group mt-lg">
									<label class="col-sm-3 control-label">title</label>
									<div class="col-sm-9">
										<input type="text" name="title" class="form-control text-semibold mt-none"><br>
									</div>
								</div>
							</div>
							...
							<table class="table">
								...
								<tbody>
									...
									foreach ($service_tr as $rs) {
										$no++;
									?>
										<form action="<?php echo base_url(); ?>adminpanel/service/updateService/<?php echo $rs->id; ?>" method="POST">
											<tr>
												<th scope="row"><?php echo $no; ?></th>
												<!-- <td>
													<a href="<?php echo base_url(); ?>adminpanel/service/loadImage/<?php echo $rs->id; ?>"><img
																width="150px"
																src="<?php echo base_url(); ?>uploads/<?php echo $rs->icon_name; ?>"></a>
												</td> -->
												...
												<td>
													...
													<a href="<?php echo base_url(); ?>adminpanel/service/deleteService/<?php echo $rs->id; ?>">
